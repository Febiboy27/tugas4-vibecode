...
function Overview({ onExplore, ranked, mapTotal, maxYear }) {
...
function MapPage({ year, setYear, metric, setMetric, selected, setSelected, selectedDistrict, selectedRate, valuesFor, max, showStations, setShowStations, stationPoint, ranked }) {
...
function About() { return <div className="page about-page"><section className="page-intro"><div><div className="eyebrow"><span className="eyebrow-line" /> TENTANG DATA</div><h1>Terbuka tentang<br /><em>data yang digunakan.</em></h1><p>Memahami sumber dan batasan adalah bagian penting dari membaca data kebencanaan.</p></div></section><div className="about-grid"><section className="about-card"><span className="eyebrow">SUMBER DATA</span><h2>Dataset yang digunakan</h2><ul><li><strong>Jumlah Peristiwa Kebakaran Menurut Kecamatan</strong><span>DKI Jakarta · 2020—2023</span></li><li><strong>Jumlah Penduduk menurut Kecamatan</strong><span>DKI Jakarta · 2019</span></li><li><strong>Data Pos Pemadam Kebakaran</strong><span>DKI Jakarta · 2024</span></li><li><strong>Jumlah Kebakaran Menurut Penyebab</strong><span>Jakarta Barat · 2021—2023</span></li></ul></section><section className="about-card"><span className="eyebrow">METODOLOGI</span><h2>Cara membaca peta</h2><p>Warna kecamatan menunjukkan jumlah peristiwa kebakaran yang tercatat. Klik kecamatan untuk melihat detail dan tren tahunan.</p><div className="notice"><Icon name="info" /><div><strong>Catatan penting</strong><p>Data kejadian bersifat agregat per kecamatan, bukan titik lokasi kebakaran. Rasio menggunakan penduduk 2019 sebagai baseline dan bersifat indikatif.</p></div></div><div className="notice soft"><Icon name="info" /><div><strong>Cakupan penyebab</strong><p>Data penyebab tersedia untuk wilayah Jakarta Barat, tetapi hanya pada tingkat tahunan.</p></div></div></section></div></div> }
